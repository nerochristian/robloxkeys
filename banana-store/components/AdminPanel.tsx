...
const cardClass = 'relative overflow-hidden bg-black/40 backdrop-blur-2xl border border-white/[0.08] rounded-3xl p-6 shadow-[0_8px_32px_rgba(0,0,0,0.5)] transition-all duration-500 hover:border-white/[0.15] hover:shadow-[0_8px_40px_rgba(250,204,21,0.06)] hover:-translate-y-0.5';
const fieldClass = 'w-full rounded-2xl border border-white/[0.06] bg-black/20 px-4 py-3.5 text-sm text-white placeholder:text-white/20 backdrop-blur-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#facc15]/30 focus:border-[#facc15]/20 focus:bg-white/[0.03] hover:border-white/[0.12]';
const fieldCompactClass = 'rounded-xl border border-white/[0.06] bg-black/20 px-3 py-2 text-sm text-white placeholder:text-white/20 backdrop-blur-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#facc15]/30 focus:border-[#facc15]/20 focus:bg-white/[0.03] hover:border-white/[0.12]';
const primaryButtonClass = 'relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#facc15] to-[#eab308] px-6 py-3.5 font-bold text-black shadow-[0_0_20px_rgba(250,204,21,0.2)] transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(250,204,21,0.4)] active:scale-[0.98] before:absolute before:inset-0 before:bg-white/20 before:opacity-0 hover:before:opacity-100 before:transition-opacity';
const subtleButtonClass = 'rounded-2xl border border-white/[0.08] bg-white/[0.02] px-5 py-3 text-sm font-semibold text-white/80 backdrop-blur-xl transition-all duration-300 hover:border-white/[0.15] hover:bg-white/[0.06] hover:text-white hover:shadow-[0_0_20px_rgba(255,255,255,0.05)] active:scale-[0.98]';
const mutedPanelClass = 'rounded-3xl border border-white/[0.05] bg-black/30 backdrop-blur-2xl p-5';
const uploadButtonClass = 'flex h-12 w-full cursor-pointer items-center justify-center rounded-2xl border border-dashed border-white/[0.15] bg-white/[0.02] px-4 text-sm font-semibold text-white/70 backdrop-blur-xl transition-all duration-300 hover:border-[#facc15]/40 hover:bg-[#facc15]/5 hover:text-[#facc15]';
...
export const AdminPanel: React.FC<AdminPanelProps> = ({ products, setProducts, settings, setSettings, onLogout }) => {
  ...
  return (
    <div className="relative flex min-h-screen min-h-[100svh] overflow-hidden bg-[#030303] text-white">
      ...
      <aside className="relative z-20 hidden w-[320px] shrink-0 flex-col border-r border-white/[0.05] bg-black/20 backdrop-blur-2xl lg:flex h-screen sticky top-0">
      ...
      <main className="relative z-10 flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
        <div className="mx-auto w-full max-w-[1280px]">
          <header className="mb-8 flex flex-col gap-6 rounded-3xl border border-white/[0.08] bg-black/30 backdrop-blur-3xl px-6 py-6 sm:px-8 lg:flex-row lg:items-center lg:justify-between shadow-[0_20px_40px_rgba(0,0,0,0.4)]">
